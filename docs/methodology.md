...
*Document de travail — v6, test de robustesse hors-échantillon complété (COVID 2020) ; backtest complet sur l'ensemble de l'échantillon en attente*
...
- [ ] Backtest complet (grand nombre de prévisions à 1 jour sur l'ensemble 2010-2026, taux de couverture empirique vs 95% nominal) — le test COVID sert de prototype réduit à cette étape, qui reste à mener sur l'échantillon complet
